 ...
 */
UCLASS()
class ABOUTGRAVITY_API UGravMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
	
	//UGravMovementComponent();
	UGravMovementComponent(const FObjectInitializer& ObjectInitializer);
