...
//	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AHeroCharacter::OnResetVR);
//}
//
//
//void AHeroCharacter::OnResetVR()
//{
...
//
//		const FVector vec = GetActorForwardVector();
//
...
//
//
//		const FVector vec = GetActorRightVector();
//
//		//AddMovementInput(vec, Value);
//	}
//}

UHeroMovementComponent* AHeroCharacter::GetHeroMovementComponent()
{
